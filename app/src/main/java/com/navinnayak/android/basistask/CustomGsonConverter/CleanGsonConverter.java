package com.navinnayak.android.basistask.CustomGsonConverter;
 ...
 * to clean the dirty Json.
 * ie;  it removes the escape character '/' and the converts the Json to Gson.
 */
